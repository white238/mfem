...
\newcommand{\LEGCY}{bench_tmop.data}
\newcommand{\TUX}{bench_tmop_tux429.data}
\newcommand{\FAST}[1]{bench_tmop_fast#1.org}
...
\begin{semilogxaxis}[
    ...
    title={TMOP-AddMultGradPA @ TUX-V100},
    ymax=600,
    ymin=0,
    xmin=1e2,
    xmax=1e7
  ...
  \addplot +[raw gnuplot] gnuplot { plot "\DATA" skip 3 using ($12):($11==1?$13:NaN)};
  \addplot +[raw gnuplot] gnuplot { plot "\DATA" skip 3 using ($12):($11==2?$13:NaN)};
  \addplot +[raw gnuplot] gnuplot { plot "\DATA" skip 3 using ($12):($11==3?$13:NaN)};
  \addplot +[raw gnuplot] gnuplot { plot "\DATA" skip 3 using ($12):($11==4?$13:NaN)};
